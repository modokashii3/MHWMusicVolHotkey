...
DWORD WINAPI dll_thread(HMODULE hDll) {
    while (true) {
        if ((GetAsyncKeyState('B') & 0x8000) &&
            ...
            else if (GetAsyncKeyState('9') & 0x8000 || GetAsyncKeyState(VK_NUMPAD9) & 0x8000) {
                user_data->at<u8>(0x104) = 90;
            }
            else if (GetAsyncKeyState('8') & 0x8000 || GetAsyncKeyState(VK_NUMPAD8) & 0x8000) {
                user_data->at<u8>(0x104) = 80;
            }
            else if (GetAsyncKeyState('7') & 0x8000 || GetAsyncKeyState(VK_NUMPAD7) & 0x8000) {
                user_data->at<u8>(0x104) = 70;
            }
            else if (GetAsyncKeyState('6') & 0x8000 || GetAsyncKeyState(VK_NUMPAD6) & 0x8000) {
                user_data->at<u8>(0x104) = 60;
            }
            else if (GetAsyncKeyState('5') & 0x8000 || GetAsyncKeyState(VK_NUMPAD5) & 0x8000) {
            ...
            else if (GetAsyncKeyState('1') & 0x8000 || GetAsyncKeyState(VK_NUMPAD1) & 0x8000) {
